package com.topu.pldriodplayerdemo.view;
...
public class CountDownView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //画边框
        if (width > height) {
            rectF.set(width / 2 - min / 2 + borderWidth / 2, 0 + borderWidth / 2, width / 2 + min / 2 - borderWidth / 2, height - borderWidth / 2);
        } else {
            rectF.set(borderWidth / 2, height / 2 - min / 2 + borderWidth / 2, width - borderWidth / 2, height / 2 - borderWidth / 2 + min / 2);
        }
