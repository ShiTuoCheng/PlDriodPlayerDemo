...
import com.topu.pldriodplayerdemo.base.VideoPlayerBaseActivity;
import com.topu.pldriodplayerdemo.utils.Utils;
import com.topu.pldriodplayerdemo.widget.MediaController;

public class FullScreenVideoActivity extends VideoPlayerBaseActivity {
...
//            Logger.i("onInfo:" + what + "___" + extra);
    ...
    private void showToastTips(final String tips) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mToast = Toast.makeText(FullScreenVideoActivity.this, tips, Toast.LENGTH_SHORT);
                mToast.show();
            }
        });
    }
    ...
    protected Handler mHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            ...
            if (!Utils.isNetworkAvailable(FullScreenVideoActivity.this)) {
