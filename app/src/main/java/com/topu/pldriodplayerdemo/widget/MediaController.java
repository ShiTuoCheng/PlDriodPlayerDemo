package com.topu.pldriodplayerdemo.widget;
...
import com.topu.pldriodplayerdemo.utils.MeasureUtil;
...
public class MediaController extends FrameLayout implements IMediaController {
    ...
    public void setAnchorView(View view) {
        ...
        if (!mFromXml) {
            ...
            Point point = MeasureUtil.getScreenSize(mContext);
            int screenHeight = point.y;
            int toolBarHeight = MeasureUtil.getToolbarHeight(mContext);
            int statusBarHeight = MeasureUtil.getStatusBarHeight(mContext);

            mWindow.setWidth(LayoutParams.MATCH_PARENT);
            //mWindow.setHeight(screenHeight - toolBarHeight - MeasureUtil.dip2px(mContext, 200));
